...
<!-- Job Listings -->
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              ...
              <ul class="my-4 bg-gray-100 p-4 rounded">
                ...
                <li class="mb-2">
                  <strong>Location:</strong> <?php echo $listing->city ;?>
                  <span
              ...
              <a href="<?php echo base_url('listing/show') . "?id=" . $listing->Id?>"
  ...
  <?php endif; ?>         
        ...
        <a href="<?php echo base_url('listing')?>" class="block text-xl text-center">
