...
?>
  <?php if(!empty($list)): ?>
    <section class="container mx-auto p-4 mt-4">
      ...
      <a class="block p-4 text-blue-700" href="<?php echo base_url('listing') ?>">
      ...
      <div class="flex space-x-4 ml-4">
        ...
        <div class="p-4">
          ...
          <ul class="my-4 bg-gray-100 p-4">
            ...
            <li class="mb-2">
              <strong>Tags:</strong> <span><?php echo $list->tags ;?></span>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section class="container mx-auto p-4">
      ...
      <a
        href="mailto:<?php echo $list->emaiil ;?>"
